...
name_label=Label(left_frame, text='Name', bg=lf_bg, font=frame_font).place(relx=0.3, rely=0.05)
...
Button(center_frame, text='Update Record', font=frame_font, width=15, command=update_records).place(relx=0.13, rely=0.6)
